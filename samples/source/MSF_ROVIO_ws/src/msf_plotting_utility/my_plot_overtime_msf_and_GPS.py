...
filename_msf = '/home/manh/catkin_ws/MSF_ROVIO_ws/src/msf_plotting_utility/recordings/_2021-06-16-15-38-30.bag'
...
for topic, msg, t in bag1.read_messages(topics="/msf_core/state_out"):
	...
	if topic == "/msf_core/state_out":
			tempdata2 = np.append(tempdata2, [[msg.header.stamp.secs+1e-9*msg.header.stamp.nsecs],[-msg.data[0]]], axis=1)
...
for topic, msg, t in bag3.read_messages(topics="/msf_core/state_out"):
	...
	#case switch how to access x coordinate for all topics
	if topic == "/msf_core/state_out":
			tempdata7 = np.append(tempdata7, [[msg.header.stamp.secs+1e-9*msg.header.stamp.nsecs],[msg.data[0]]], axis=1)
			tempdata8 = np.append(tempdata8, [[msg.header.stamp.secs+1e-9*msg.header.stamp.nsecs],[msg.data[1]]], axis=1)
			tempdata9 = np.append(tempdata9, [[msg.header.stamp.secs+1e-9*msg.header.stamp.nsecs],[msg.data[2]]], axis=1)
	#topicdata

...
filename_msf = '/home/manh/catkin_ws/MSF_ROVIO_ws/src/msf_plotting_utility/recordings/_2021-06-13-13-22-00.bag'
...
for topic, msg, t in bag1.read_messages(topics="/msf_core/state_out"):
	...
	if topic == "/msf_core/state_out":
			tempdata2 = np.append(tempdata2, [[msg.header.stamp.secs+1e-9*msg.header.stamp.nsecs-start_time_1],[-msg.data[0]]], axis=1)
			tempdata1 = np.append(tempdata1, [[msg.header.stamp.secs+1e-9*msg.header.stamp.nsecs-start_time_1],[-msg.data[1]]], axis=1)
